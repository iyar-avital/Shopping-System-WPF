...
//        public Apriori(double t, List<List<Product>> input, int threshold, int confidence)
//        {
//            treshold = t;
...
//        public Apriori(int threshold, int confidence)
//        {
...
//            {
//                if (item.Value >= treshold)
//                {
//                    set = new ItemSet();
//                    set.k = item.Key.k;
//                    set.items = item.Key.items;
//                    val = item.Value;
//                    result.Add(set, val);
//                    // Dictionary<ItemSet, double> _new = new Dictionary<ItemSet, double>();
//                    //result.Union(_new);
//                }
//            }
//            return result;
