...
namespace Shopping_system
{
    public static class AprioriHelper
    {
        ...
        public static RulesVM convertToRuleVM(this AssociationRule ar)
        {
            return new RulesVM(ar);
        }

        public static ObservableCollection<RulesVM> GetRuleVM(this List<AssociationRule> associationRules)
        {
            ObservableCollection<RulesVM> rulesVMs = new ObservableCollection<RulesVM>();
            foreach (var rule in associationRules)
            {
                rulesVMs.Add(rule.convertToRuleVM());
            }
            return rulesVMs;
        }
    }
